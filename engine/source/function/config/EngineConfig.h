...
/// 实体初始显隐状态（entities.json `initialEntityState`，字面值契约见 实体管理设计.md §4）。
...
/// One `entities[]` item（目录字段见 实体管理设计.md §4；pose 双轨见 位姿配置设计.md）。
struct EntityConfig
{
    int id = 0;
    std::string name;
...
/// 契约：实体管理设计.md §4（id 1..65535 唯一 / model 必填 / name 缺省 basename /
