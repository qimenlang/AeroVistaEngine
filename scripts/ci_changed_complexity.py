...
TIDY_RE = re.compile(r"^(engine|thirdparty/sync|thirdparty/config)/.+\.(cpp|cc|cxx|h|hpp|hh|hxx)$", re.I)
LIZARD_RE = re.compile(r"^(engine/source|thirdparty/sync/src|thirdparty/config/src)/.+\.(cpp|cc|cxx)$", re.I)
